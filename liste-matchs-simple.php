<!DOCTYPE html>
  ...
  <div class="choix-match-content">
    <div class="choix-match-left">
        ...
        <form action="match-simple-traitement.php" method="post" class="filtre-matchs">
    ...
    <div class="choix-match-right">
        <div class="choix-match-title">
            <h2> Liste des matchs du tournoi Simple </h2>
        </div>
        ...
        <div class="choix-match-liste"> 
            ...
            <a href="match-categ.php"><!-- Lien à relier au match choisis-->
                <div class="liste-match-element">
                    <header>Joueur 1 vs Joueur 2 <header>
                    <h2> A tel date </h2>
                    <h2> Tour </h2>
                </div>
            </a>

            <a href="match-categ.php">
                <div class="liste-match-element">
                    <header>Joueur 1 vs Joueur 2 <header>
                    <h2> A tel date </h2>
                    <h2> Tour </h2>
